...
TERMINFO="/home/493914/local/share/terminfo"
TERMINFO_DIRS="/home/493914/local/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/493914/ncurses-6.5/man_alias.sed" ; then
cat >>/home/493914/ncurses-6.5/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/493914/ncurses-6.5/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/493914/ncurses-6.5/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/493914/ncurses-6.5/man_alias.sed" \
		< "$i" >$TMP
